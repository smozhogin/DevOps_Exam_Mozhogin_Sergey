...
**app (inference / API):**
Назначение: Публикация REST API для инференса и проверок состояния.

**trainer (training job / pipeline):**
Назначение: Обучение и переобучение модели.

**mlflow (tracking / registry):**
Назначение: Централизованный трекинг экспериментов и хранение артефактов.
